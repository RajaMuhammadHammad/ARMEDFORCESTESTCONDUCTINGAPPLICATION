<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ISSBform.aspx.cs" Inherits="Project.ISSBform" %>
    ...
    <option value="airforce">Pakistan Airforce</option>           
                ...
                <div class="d-flex mb-4 gap1 flex-wrap">
                    <div class="form-group ">
                        <label for="pnr&sc" class="form-label">PNR & SC:</label>
                        <select class="form-select " id="pnr&sc">
                            <option value="" >--Karachi PNR & SC--</option>
                            <option value="" >--Lahore PNR & SC--</option>
                            <option value="" >--Rawalpindi PNR & SC--</option>
                            <option value="" >--Peshawar PNR & SC--</option>
                            <option value="" >--Hyderabad PNR & SC--</option>
                            <option value="" >--Select PNR & SC--</option>
                        </select>
                    </div>
                    <div class="form-group ">
    ...
    <input type="date" id="dob" runat="server" class="form-control email" name="dob" placeholder="Date Of Birth">
          ...
          another)</b>
            ...
            <div class="form-field text-center">
                ...
                <br />
                <br />
                <asp:Button ID="submitBtn0" runat="server" Text="Proceed" OnClick="submitBtn0_Click" />
            </div>
        </form>
